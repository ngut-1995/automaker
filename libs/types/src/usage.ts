/**
 * Usage types for provider quota tracking (Claude, Codex, z.ai, Gemini).
 *
 * These mirror the server responses for the usage endpoints and are shared so
 * the operation contract can describe them without importing UI code.
 */
